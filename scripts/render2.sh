...
--gin_bindings="Config.data_dir = './datasets/llnerf-dataset/still3'" \
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__still3_s3im'" \
--gin_bindings="Config.render_path = True" \
--gin_bindings="Config.batch_size = 1024" \
--gin_bindings="Config.render_dir = './nerf_results/llnerf/llnerf__still3_s3im/render/'" \
...
--gin_bindings="Config.s3im_loss_mult = 0.5"