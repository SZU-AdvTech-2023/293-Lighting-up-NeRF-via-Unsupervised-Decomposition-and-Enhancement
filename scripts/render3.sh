...
--gin_bindings="Config.data_dir = './datasets/llnerf-dataset/path'" \
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__path'" \
--gin_bindings="Config.render_path = False" \
--gin_bindings="Config.batch_size = 1024" \
--gin_bindings="Config.render_dir = './nerf_results/llnerf/llnerf__path/render/'" \
