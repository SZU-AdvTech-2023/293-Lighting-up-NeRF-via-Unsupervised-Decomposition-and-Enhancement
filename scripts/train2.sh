...
--gin_bindings="Config.data_dir = './datasets/llnerf-dataset/still2'" \
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__still2'" \
...
--gin_bindings="Config.logfile = 'logs/llnerf__still2.txt'" \
--logtostderr \
