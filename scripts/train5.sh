...
--gin_bindings="Config.data_dir = './datasets/LOM_full/sofa'" \
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__sofa'" \
...
--gin_bindings="Config.logfile = 'logs/llnerf__sofa.txt'" \
--logtostderr \
