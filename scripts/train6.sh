...
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__bike_itmse_s3im0.01'" \
...
--gin_bindings="Config.logfile = 'logs/llnerf__bike_itmse_s3im0.01.txt'" \
--logtostderr \
--gin_bindings="Config.data_loss_type = 'mse'" \
...
--gin_bindings="Config.s3im_loss_mult = 0.01" \
