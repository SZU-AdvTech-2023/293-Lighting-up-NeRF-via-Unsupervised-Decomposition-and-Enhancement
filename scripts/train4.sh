...
--gin_bindings="Config.data_dir = './datasets/llnerf-dataset/moto'" \
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__moto'" \
...
--gin_bindings="Config.logfile = 'logs/llnerf__moto.txt'" \
--logtostderr \
