...
--gin_bindings="Config.checkpoint_dir = './nerf_results/llnerf/llnerf__bike_mse_s3im0.1'" \
...
--gin_bindings="Config.logfile = 'logs/llnerf__bike_mse_s3im0.1.txt'" \
--logtostderr \
...
--gin_bindings="Config.s3im_loss_mult = 0.1" \
