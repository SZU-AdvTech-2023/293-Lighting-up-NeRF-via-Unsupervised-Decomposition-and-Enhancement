...
class Config:
  ...
  valid_steps: Union[int, list] = 5000  # Steps between test set renders when training
  ...
  render_ckpt_step: int = None  # None for the latest step
  ...
  # print output file
  logfile: str = './tmp_log.txt'
  sample_neighbor_num: int = 0 
  exposure_loss_mult: float = 0.
  exposure_loss_use_mean: bool = True
  gray_loss_mult: float = 0.
  gray_loss_clip: float = 0.
  Ggray_loss_mult: float = 0.  # Gamma gray loss
  Agray_loss_mult: float = 0.  # Alpha gray loss
  Le_gray_loss_mult: float = 0.
  cos_loss_mult: float = 0.
  Ce_data_loss_mult: float = 0.
  gamma_norm_loss_mult: float = 0.
  alpha_norm_loss_mult: float = 0.
  residual_norm_loss_mult: float = 0.
  ltv_loss_mult: float = 0.
  gamma_ltv_loss_mult: float = 0.
  alpha_ltv_loss_mult: float = 0.
  beta_ltv_loss_mult: float = 0.
  spatial_loss_mult: float = 0.
  smooth_L_ratio: bool = False
  fixed_exposure: float = 0.5
  m_contrast_loss_mult: float = 0.

  data_mlp_ckpt: str = None  # if setted, load the pretrained nerf from ckpt and only learn gamma & alpha
  data_mlp_ckpt_step: int = None
  render_img_num: int = None
  gray_variance_bias: float = 1.0
  disable_enhancement_loss: bool = False
  coeff_ltv_ref: str = 'L_sg'
